  ...
  const projects = [
    {
      ...
      liveDemo: "https://transworld-project.vercel.app/",
      github: "https://github.com/Amir-Sohail-official/transworld_project",
      technologies: ["Next.js", "tailwindcss", "State Management"],
    },
    {
      title: " E-CommercePlatform(Next.js + React.js)",
      type: "Full Stack (React.js + Next.js)",
      description:
        "Full-stack e-commerce system with authentication, cart, and admin dashboard.Increase user activity and interactivity by making sure to follow the UI/UX design principles",
      liveDemo: "https://e-commerce-plateform.vercel.app/",
      github: "https://github.com/Amir-Sohail-official/e-commerce-plateform",
      technologies: ["React.js", "Next.js", "CSS3", "State Management"],
    },
    {
      title: "Online Service Booking Platform (MERN Stack)",
      type: "Full Stack (MERN)",
      description:
        "Booking platform with user authentication and admin management. Built with MongoDB, Express.js, React.js, and Node.js, this project allows users to book services online while providing an admin dashboard for managing bookings and user accounts.",
      liveDemo: "https://online-service-booking-platform-y3c.vercel.app/",
      github:
        "https://github.com/Amir-Sohail-official/online-service-booking-platform",
